        ...
        <>
            ...
            <nav className='header-area sticky'>
                <ul className='sidebar'>
                    ...
                    <li onClick={handleMenuClose}><NavLink to="/">Home</NavLink></li>
                    <li onClick={handleMenuClose}><NavLink to="/properties">Properties</NavLink></li>
                    <li onClick={handleMenuClose}><NavLink to="/contact-us">Contact Us</NavLink></li>
                </ul>
                <ul>
                    <li>
                    ...
                    <li className='menu-button' onClick={handleMenuToggle}><Link to="#"><i><FontAwesomeIcon icon={faList} /></i></Link></li>
                </ul>
            </nav>
        </>
    )
